...
RSpec.describe TopicsController, type: :controller do
  ...
  #members can create topics or edit their own
  context "member user" do
    before do
      user = User.create!(name: "Linkit User", email: "user@email.com", password: "password", role: :member)
      create_session(user)
    end
  ...
  #admins can view, create, edit and destory topics
  context "admin user" do
    before do
      user = User.create!(name: "Linkit User", email: "user@email.com", password: "password", role: :admin)
      create_session(user)
    end
  ...
  #mods can update or view topics, but not create/destroy
