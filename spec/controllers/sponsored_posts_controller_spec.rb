...
RSpec.describe SponsoredPostsController, type: :controller do
  #nest sponsored_post under topic
  ...
  #creates an unsaved new sponsored_post object
  describe "GET #new" do
    it "returns http success" do
  ...
  #saves the new sponsored_post to the database
  ...
  describe "DELETE destroy" do
    it "deletes the sponsored_post" do
      ...
      #make sure the database no longer contains a matchingsponsored_post
