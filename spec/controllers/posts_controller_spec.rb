...
RSpec.describe PostsController, type: :controller do
  #nest post under topic
  let(:my_user) { User.create!(name: "New User", email: "user@email.com", password: "password") }
  ...
  describe "DELETE destroy" do
    it "deletes the post" do
      delete :destroy, params: { topic_id: my_topic.id, id: my_post.id }
      #make sure the database no longer contains a matching post
